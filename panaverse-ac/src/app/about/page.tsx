        ...
        <Container maxW={1400}>
            <Flex display={{lg:'flex', base:'grid'}}>
                <Box flexBasis={'50%'} m='auto'><Center>
                    <Image src={president} alt='Presedent of Pakistan'/></Center>
                </Box>
                <Box flexBasis={'50%'} mt={{base:'20px', lg:'0'}}>
                  <Heading bgGradient='linear(to-l, #7928CA, #FF0080)' bgClip='text'>Dr. Arif Alvi</Heading>
        ...
        <Container maxW={1400}>
            <Flex display={{lg:'flex', base:'grid'}}>
                <Box flexBasis={'50%'} m='auto'>
                  <Heading bgGradient='linear(to-l, #7928CA, #FF0080)' bgClip='text'>Panaverse DAO</Heading>
                  <Text mt={'20px'} mr={{lg:'50px', base:'0'}}>Panaverse DAO is a community of Web 3 and Metaverse developers, designers, trainers, startup founders and service providers. Panaverse DAO is struggling to produce professional metaverse developers from Pakistan for the upcoming Era of Internet</Text>
                </Box>
                <Box flexBasis={'50%'} mt={{base:'20px', lg:'0'}}>
    ...
    <Box p={'60px'}>
        <Container maxW={1400}>
            <Flex display={{lg:'flex', base:'grid'}}>
                ...
                <Box flexBasis={'50%'} mt={{base:'20px', lg:'0'}}>
                  <Heading bgGradient='linear(to-l, #7928CA, #FF0080)' bgClip='text'>Zia Khan</Heading>
